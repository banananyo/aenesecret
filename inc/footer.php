<footer id="gtco-footer" role="contentinfo">
    <div class="gtco-container">
        <div class="row row-p	b-md">
            ...
            <div class="col-md-4">
                <div class="gtco-widget">
                    <h3>เกี่ยวกับเรา</h3>
                    <p>Aene Secret XS (เอเน่ ซีเครท เอ็กซ์ เอส) ผลิตภัณฑ์อาหารเสริมสินค้า ลดน้ำหนัก ปลอดภัย ไม่มีผลข้างเคียง สลายไขมัน ไม่กลับมา โยโย่ แน่นอน ผลิตภัณฑ์มาตราฐาน อย. GMP ไม่เชื่อ ก็ ลองดูสิ แค่ ผอม ก็ เผ็ช! เชื่อสิ</p>
                </div>
            </div>
            ...
            <div class="col-md-4">
                <div class="gtco-widget">
                    ...
                    <ul class="gtco-quick-contact">
                        <li><a href="tel:0635345655"><i class="icon-phone"></i>  โทร. 063-534-5655</a></li>
                        <li><a href="mailto:aenesecretthailand@gmail.com"><i class="icon-mail2"></i> aenesecretthailand@gmail.com</a></li>
                    </ul>
                </div>
            </div>
        ...
        <div class="row copyright">
            <div class="col-md-12">
                <p class="pull-left">
                    <small class="block">&copy; 2018 AeneSecretThailand.com. All Rights Reserved.</small>
